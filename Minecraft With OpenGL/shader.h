...
public:
	...
	Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath = nullptr)
	{
		...
		if (geometryPath != nullptr and geometry != NULL)
			glAttachShader(ID, geometry);
		glLinkProgram(ID);
		checkCompileErrors(ID, "PROGRAM");
		// Delete the shaders as they're linked into the program now and are just taking up space
...
private:
	// Util function for checking shader compilation/linking errors
